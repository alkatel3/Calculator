...
{
    public partial class Calculator_2:Form
    {
        int a, b;
        string count;
        ...
        private void ClickSimpleOperation(object sender, EventArgs e)
        {
            if (!clickOperation)
            {
                ...
                label2.Text = Convert.ToString(a, 2) + ((Button)sender).Text;
                clickOperation = true;
                return;
            }
        ...
        private void ClickPlusMinus(object sender, EventArgs e)
        {
            if (textBox1.Text.Length > 0)
            {
                ...
                textBox1.Text = Convert.ToString(c * (-1), 2);
            }
        }
        ...
        private void Calculate()
        {
            ...
            {
                case "+":
                    b = a + Convert.ToInt32(textBox1.Text, 2);
                    textBox1.Text = Convert.ToString(b, 2);
                    break;
                case "-":
                    b = a - Convert.ToInt32(textBox1.Text, 2);
                    textBox1.Text = Convert.ToString(b, 2);
